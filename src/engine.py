...
#Global Variable
malware_hashes = list(open("C:\\Users\\student\\Desktop\\Antivirus\\src\\DataBase\\HashDataBase\\Sha256\\virusHash.txt","r").read().split('\n'))
virusInfo = list(open("C:\\Users\\student\\Desktop\\Antivirus\\src\\DataBase\\HashDataBase\\Sha256\\virusInfo.txt","r").read().split('\n'))
...
def ramBooster():
    ...
    taskList = ["AnyDesk.exe","TeamViewer_Service.exe","msedge.exe","IDMan.exe","notepad.exe","chrome.exe","Discord.exe","Taskmgr.exe","msedge.exe","mspaint.exe","EpicGamesLauncher.exe"]
